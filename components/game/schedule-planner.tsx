...
const FIXED_HOURS = 56 + 21 + 14 // Sleep (8h/day) + Classes (3h/day) + Meals/Hygiene (2h/day) = 91 hours
const AVAILABLE_HOURS = HOURS_PER_WEEK - FIXED_HOURS // 77 hours of free time
...
const activities = [
  {
    ...
    effects: { happiness: -0.3, gpa: 1.5, social: -0.2 },
  },
  {
    key: "work" as const,
    label: "Part-time Job",
    ...
    effects: { happiness: -0.2, gpa: -0.3, social: 0.3 },
  },
  {
    ...
    effects: { happiness: 0.8, gpa: -0.2, social: 1.2 },
  },
  {
    key: "party" as const,
    label: "Party",
    ...
    effects: { happiness: 1.2, gpa: -0.8, social: 0.8 },
  },
  {
    ...
    effects: { happiness: 0.6, gpa: 0.2, social: 0.3 },
  },
  {
    key: "rest" as const,
    label: "Rest & Hobbies",
    ...
    effects: { happiness: 0.9, gpa: -0.1, social: -0.3 },
  },
]

const yearThemes = [
  { name: "Frosh Year", subtitle: "Everything is new and exciting" },
  { name: "Sophomore Year", subtitle: "Reality starts to hit" },
  { name: "Junior Year", subtitle: "Co-op, internships, and stress" },
  { name: "Senior Year", subtitle: "The final stretch" },
]
...
export function SchedulePlanner({ year, initialStats, onComplete }: SchedulePlannerProps) {
  ...
  // Calculate projected stats based on schedule
    ...
    <div className="min-h-screen bg-[#1a1a2e] flex flex-col">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          {/* Projected Stats */}
          <div className="bg-[#002145]/70 rounded-xl p-4 border border-[#C4A747]/30">
            <h2 className="text-white font-semibold mb-3">Projected Weekly Stats</h2>
